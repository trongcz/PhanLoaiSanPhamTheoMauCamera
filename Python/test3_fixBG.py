...
def detect_color(frame):
    ...
    masks = {
        ...
        "GREEN": cv2.inRange(hsv,(40,80,80),(80,255,255)),
...
def remove_background(frame):
    ...
    bg_blur = cv2.GaussianBlur(background, (21,21), 0)
    frame_blur = cv2.GaussianBlur(frame, (21,21), 0)

    diff = cv2.absdiff(bg_blur, frame_blur)
...
def camera_loop():
    ...
    while running:
        ...
        if time.time() - last_detect > 0.2:
            ...
            # 👉 vẫn giữ delay để tránh spam quá nhanh
